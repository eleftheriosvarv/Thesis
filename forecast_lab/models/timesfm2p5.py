...
@register_model("timesfm2.5", schema=SCHEMA)
def run_timesfm2p5(df: pd.DataFrame, cfg: dict):
    target = cfg["target"]
    ...
    return {"model": "timesfm2.5", "yhat": yhat, "meta": {"lookback": lookback, "horizon": horizon}}
