...
@register_model("chronosbolt", schema=SCHEMA)
def run_chronosbolt(df: pd.DataFrame, cfg: dict):
    target = cfg["target"]
    ...
    return {"model": "chronosbolt", "yhat": yhat, "meta": {"lookback": lookback, "horizon": horizon}}
